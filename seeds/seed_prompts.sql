INSERT INTO lossforwords_prompts (prompt_content, category, author)
VALUES  
    ...
    ("Tell this story: “I've seen a few fridge related disasters in my life, but this was the fridge disaster to end all fridge disasters.“", "Comedy", "Unknown"),
    ...
    ("You've discovered a magical bowl that automatically refills with whatever you choose, with one restriction: It can't be money. What do you do?", 'Fantasy', 'Unkown'),
    ('A writer loses the abilit to distinguish reality fro the fantastical worlds of their stories.', 'Fiction', 'Unknown'),
    ...
    ("You're legally allowed to commit murder once, but you must first fill out the proper paperwork... and your proposed victim must be notified of your intentions", 'Mystery', 'Unknown'),
    ('Write a letter to your dad.', 'Nonfiction', 'Unknown'),
    ('Narrate a photo: Find a picure that intrigues you and write about it. What does it remind you of? What does it make you feel? What does it make you think about?', 'Nonfiction', 'Unknown'),
    ...
    ("A troubled teenager discovers he has the power to see people's futures by touching them. When he accidentally bumbs into a man on the subway, he see's him piloting a spaceship and it's headed straight toward the city. Now he must find the man—and convince everyone else that the fanger is real.", 'Science Fiction', 'Unknown'),
