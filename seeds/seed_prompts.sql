...
VALUES  
    ...
    ('You have discovered a magical bowl that automatically refills with whatever you choose, with one restriction: It can nott be money. What do you do?', 'Fantasy', 'Unkown'),
